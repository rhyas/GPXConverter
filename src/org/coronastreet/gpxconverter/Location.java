 ...
 * 
 * This code is based on Android source code. Specifically the 
...
public class Location {
    ...
    public void dump(String prefix) {
        System.out.println(prefix + "mProvider=" + mProvider + " mTime=" + mTime);
        System.out.println(prefix + "mLatitude=" + mLatitude + " mLongitude=" + mLongitude);
        System.out.println(prefix + "mHasAltitude=" + mHasAltitude + " mAltitude=" + mAltitude);
        System.out.println(prefix + "mHasSpeed=" + mHasSpeed + " mSpeed=" + mSpeed);
        System.out.println(prefix + "mHasBearing=" + mHasBearing + " mBearing=" + mBearing);
        System.out.println(prefix + "mHasAccuracy=" + mHasAccuracy + " mAccuracy=" + mAccuracy);
    }
     ...
     */
    public void set(Trkpt t) {
    	try {
    		DateFormat df = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");
    		mTime = df.parse(t.getTime()).getTime();
    		mLatitude = Double.parseDouble(t.getLat());
    		mLongitude = Double.parseDouble(t.getLon());
    		mAltitude = Double.parseDouble(t.getElevation());
    	} catch (Exception e) { 
    		e.printStackTrace();
    	}
    }
